...
tf.flags.DEFINE_string("data_file", "train_set.csv", "Data source for the positive data.")
...
def train(x_train, y_train, vocab_processor, x_dev, y_dev):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join('/Users/liyangyang/PycharmProjects/mypy/venv/dwb/testcnn/model/', "runs", timestamp))
            print("Writing to {}\n".format(out_dir))

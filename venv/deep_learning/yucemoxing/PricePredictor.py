...
class PricePredictor:
    ...
    dataFile = '/Users/liyangyang/PycharmProjects/mypy/venv/deep_learning/yucemoxing/chargeInfo.txt'
        ...
        with tf.Session() as sess:
            ...
            for i in range(100):
                ...
                while end < len(self.train_x):
                    ...
                    if step % 10 == 0:
                        print(i, step, loss_)
                        print("保存模型：", saver.save(sess, '/Users/liyangyang/PycharmProjects/mypy/venv/deep_learning/yucemoxing/model/stock.model'))
                    step += 1
    ...
    def prediction(self):
        ...
        with tf.Session() as sess:
            # 参数恢复
            module_file = tf.train.latest_checkpoint('/Users/liyangyang/PycharmProjects/mypy/venv/deep_learning/yucemoxing/model/')
...
# print('sortedChargeList:')
# print(predictor.sortedChargeList)
# print('chargeList')
# print(predictor.chargeList)
# print('date2Charge')
# print(predictor.date2Charge)
# print('date2Price')
# print(predictor.date2Price)

# 构建训练数据
predictor.buildTrainDataSet()
# print(predictor.train_x[0:10])
# print(predictor.train_y[0:10])
